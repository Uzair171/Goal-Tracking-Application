...
const QuarterThree = () => {
  ...
  const goals = useSelector((state) => state.goals?.quarterThreeGoals || []);
  ...
  const handleAddGoal = () => {
    ...
    dispatch(addGoal({ quarter: "quarterThree", goal: newGoal }));
    setNewGoalName("");
  };

  const handleDeleteGoal = (goalId) => {
    dispatch(deleteGoal({ quarter: "quarterThree", goalId }));
  };
  ...
  const handleAddTactic = (goalId) => {
    ...
    dispatch(setGoals({ quarter: "quarterThree", goals: updatedGoals }));
  };
