...
const QuarterTwo = () => {
  ...
  const goals = useSelector((state) => state.goals?.quarterTwoGoals || []);
  ...
  const handleAddGoal = () => {
    ...
    dispatch(addGoal({ quarter: "quarterTwo", goal: newGoal }));
    setNewGoalName("");
  };

  const handleDeleteGoal = (goalId) => {
    dispatch(deleteGoal({ quarter: "quarterTwo", goalId }));
  };
  ...
  const handleAddTactic = (goalId) => {
    ...
    dispatch(setGoals({ quarter: "quarterTwo", goals: updatedGoals }));
  };
