...
const QuarterOne = () => {
  ...
  const goals = useSelector((state) => state.goals?.quarterOneGoals || []);
  ...
  const handleDeleteGoal = (goalId) => {
    dispatch(deleteGoal({ quarter: "quarterOne", goalId }));
  };
  ...
  const handleAddTactic = (goalId) => {
    ...
    dispatch(setGoals({ quarter: "quarterOne", goals: updatedGoals }));
  };
